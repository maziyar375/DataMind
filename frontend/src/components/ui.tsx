...
export const Icon = {
  ...
  // `Alert` is the same circle with the glyph the other way up. They are drawn
  // as two icons rather than one flipped one because they mean opposite
  // things, and a rotated warning triangle is how an "information" badge ends
  // up coloured red by whoever reads it next.
  Info: ({ size = 17, stroke = 'currentColor', strokeWidth = 2 }: IconProps) => (
    <svg {...iconBase(size, stroke, strokeWidth)}>
      <circle cx="12" cy="12" r="10" />
 ...
 * or an empty result looks like. Moved, not copied (docs/reference/dashboards.md §6).
 *
      ...
      {spec.delta && (
        ...
        >
          {/* Direction is drawn, never coloured. Green-for-up is a judgement
              ...
              rather than guessed at here — docs/reference/charts.md §7. */}
 ...
 * `ResultTable` was moved here rather than duplicated (docs/reference/dashboards.md §6).
 */
/**
